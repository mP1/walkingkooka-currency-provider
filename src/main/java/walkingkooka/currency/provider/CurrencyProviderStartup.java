 ...
 */
public final class CurrencyProviderStartup implements PublicStaticHelper {

    static {
        PluginStartup.init();

        // register json marshallers/unmarshallers.
        CurrencyExchangeRaterAliasSet.EMPTY.size();
        CurrencyExchangeRaterInfoSet.EMPTY.size();
    ...
    private CurrencyProviderStartup() {
