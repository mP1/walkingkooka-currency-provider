...
/**
 * A {@link CurrencyExchangeRaterProvider} that wraps a view of new {@link CurrencyExchangeRaterName} to a wrapped {@link CurrencyExchangeRaterProvider}.
 */
final class FilteredMappedCurrencyExchangeRaterProvider implements CurrencyExchangeRaterProvider {

    static FilteredMappedCurrencyExchangeRaterProvider with(final CurrencyExchangeRaterInfoSet infos,
                                                            final CurrencyExchangeRaterProvider provider) {
        Objects.requireNonNull(infos, "infos");
        Objects.requireNonNull(provider, "provider");

        return new FilteredMappedCurrencyExchangeRaterProvider(
            infos,
            provider
        );
    }

    private FilteredMappedCurrencyExchangeRaterProvider(final CurrencyExchangeRaterInfoSet infos,
                                                        final CurrencyExchangeRaterProvider provider) {
    ...
    private final FilteredProviderMapper<CurrencyExchangeRaterName, CurrencyExchangeRaterInfo, CurrencyExchangeRaterInfoSet, CurrencyExchangeRaterSelector, CurrencyExchangeRaterAlias, CurrencyExchangeRaterAliasSet> mapper;
